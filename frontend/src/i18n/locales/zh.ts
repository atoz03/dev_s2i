export default {
  ...
  admin: {
    ...
    groups: {
      ...
      creating: '创建中...',
      updating: '更新中...',
      accountDefaultGroupTitle: '账号管理默认组',
      accountDefaultGroupHint: '仅保存在当前浏览器。设置后，账号管理页每次进入都会优先展示这个分组；重新设置其他分组时会自动覆盖。',
      accountDefaultGroupAction: '设为默认组',
      accountDefaultGroupBadge: '默认组',
      limitDay: '日',
      limitWeek: '周',
      limitMonth: '月',
      groupCreated: '分组创建成功',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将设备和会话标识收敛为账号级恒定值；关闭时原样透传客户端标识。默认关闭：开启会改写上游已与该账号关联的标识，实测可能触发额度惩罚。',
      ...
      account: '账号',
      readyToTest: '准备测试。默认使用 ping/pong 测活模板，点击"开始测试"按钮开始...',
      connectingToApi: '连接 API 中...',
      testCompleted: '测试完成，已命中 pong 校验！',
      connectedToApi: '已连接到 API',
      usingModel: '使用模型：{model}',
      sendingTestMessage: '发送 ping/pong 测活模板，预期响应包含 "pong"',
      testTemplateSummary: '测活模板：发送 ping / ping, please reply pong，并校验响应包含 "pong"',
      testResponseValidation: '校验规则：响应文本必须包含 "pong" 才视为成功',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigning: 'CCH 签名',
        cchSigningHint: '为转发请求补充 CCH 签名参数，按需开启。',
      ...
      betaPolicy: {
        title: 'Beta 策略',
        description: '控制 Anthropic 请求中的 Beta 参数处理方式（仅 /v1/messages）。',
        action: '处理方式',
        actionPass: '透传（不处理）',
        actionFilter: '过滤（移除）',
        actionBlock: '拦截（拒绝请求）',
        quickPresets: '快捷预设',
        presetOpusOnly: '仅允许 Opus 相关 Beta',
        presetOpusOnlyDesc: '只保留 Opus 所需 Beta，其它 Beta 按规则处理。',
        scope: '生效范围',
        scopeAll: '全部账号',
        ...
        modelWhitelist: '模型白名单',
        modelWhitelistHint: '命中白名单模型时优先放行，可用通配符。',
        addModelPattern: '添加模型规则',
        modelPatternPlaceholder: '例如 claude-3-5-sonnet*',
        commonPatterns: '常用规则',
        fallbackAction: '兜底处理',
        fallbackActionHint: '未命中规则时使用此处理方式。',
        fallbackErrorMessagePlaceholder: '兜底拦截时返回的错误消息',
        errorMessage: '错误消息',
      ...
      openaiExperimentalScheduler: {
        title: 'OpenAI 实验调度策略',
        description: '开启后使用实验版 OpenAI 账号调度逻辑；默认关闭。'
      },
      saveSettings: '保存设置',
      saving: '保存中...',
