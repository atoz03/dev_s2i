export default {
  ...
  admin: {
    ...
    groups: {
      ...
      creating: 'Creating...',
      updating: 'Updating...',
      accountDefaultGroupTitle: 'Default group for account management',
      accountDefaultGroupHint: 'Stored only in this browser. Once set, the account management page will open with this group selected by default every time you enter; setting another group will replace it automatically.',
      accountDefaultGroupAction: 'Set as default group',
      accountDefaultGroupBadge: 'Default',
      limitDay: 'd',
      limitWeek: 'w',
      limitMonth: 'mo',
    ...
    accounts: {
      ...
      account: 'Account',
      readyToTest: 'Ready to test. The default probe uses the ping/pong template. Click "Start Test" to begin...',
      connectingToApi: 'Connecting to API...',
      testCompleted: 'Test completed and matched the pong validation!',
      testFailed: 'Test failed',
      connectedToApi: 'Connected to API',
      usingModel: 'Using model: {model}',
      sendingTestMessage: 'Sending the ping/pong probe template. Expected response must contain "pong"',
      testTemplateSummary: 'Probe template: send ping / ping, please reply pong, then validate the response contains "pong"',
      testResponseValidation: 'Validation rule: the response text must contain "pong" to pass',
