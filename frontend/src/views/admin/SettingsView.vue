          ...
          <div class="grid grid-cols-1 gap-3 p-6 lg:grid-cols-2">
            ...
            >
              <div class="flex items-center justify-between gap-4">
                ...
                <Toggle
                  :model-value="isAdminMenuVisible(option.key)"
                  @update:model-value="(visible: boolean) => setAdminMenuVisible(option.key, visible)"
                />
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <a :href="isZhLocale ? 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/PAYMENT_CN.md' : 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/PAYMENT.md'" target="_blank" rel="noopener noreferrer" class="ml-2 inline-flex items-center text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
            ...
            <template v-if="form.payment_enabled">
              ...
              <div>
                ...
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                  ...
                  <a :href="isZhLocale ? 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/PAYMENT_CN.md#支持的支付方式' : 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/PAYMENT.md#supported-payment-methods'" target="_blank" rel="noopener noreferrer" class="ml-1 text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300">
...
function isAdminMenuVisible(key: AdminBuiltinMenuItemKey): boolean {
  return !form.hidden_admin_menu_items.includes(key)
}

function setAdminMenuVisible(key: AdminBuiltinMenuItemKey, visible: boolean) {
