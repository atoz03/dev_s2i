...
func isImageGenerationModel(model string) bool {
	modelLower := strings.ToLower(strings.TrimPrefix(strings.TrimSpace(model), "models/"))
...
// buildCodeAssistRequest builds request for Google Code Assist API。
