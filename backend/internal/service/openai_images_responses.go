...
//nolint:unused // 预留用于流式 partial image 事件透传。
...
//nolint:unused // 预留用于流式 completed 事件透传。
...
//nolint:unused // 预留给 OAuth 流式生图事件写回。
...
//nolint:unused // 预留给 OAuth 非流式生图回包兼容。
