...
// setOpsUpstreamRequestBody is retained as a compatibility no-op.
// Upstream replay storage was removed, but some gateway paths still call this
// helper during request forwarding; keeping it prevents compile breakage while
