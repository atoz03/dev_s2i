...
type AdminService interface {
	...
	EnsureOpenAIPrivacy(ctx context.Context, account *Account) string // ForceOpenAIPrivacy 强制重新设置 OpenAI OAuth 账号隐私，无论当前状态。
...
func (s *adminServiceImpl) DeleteUser(ctx context.Context, id int64) error {
	...
	if s.entClient != nil {
		...
		apiKeys, err = s.listUserAPIKeysForDeletion(opCtx, id)
		if err != nil {
			return err
		}
