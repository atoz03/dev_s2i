...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, endpointProbeService, endpointProbePlanService, paymentConfigService, paymentService)
