...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountHandler := admin.NewAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, soraS3Storage, endpointProbeService, endpointProbePlanService, paymentConfigService, paymentService)
